...
<li id="logo"><a href="#"> <img src="resources(src)/images/profile.png" width="35px" height="35px"></a></li>
	<br><p class="test1"><strong><a href="#">Login</a> / <a href="#">Register</a></strong></p>
            ...
            <form action="submiteditsupport.php" method= "POST">
                <h1>Support Form</h1>
				
				        <h3>sup_id</h3>
                        <input type="text" value= "<?php echo "$sup_id" ?>" name="support_id" readonly><br><br>
                        <h3>Name</h3>
                    ...
                    <input type="submit" value="Update supports">
