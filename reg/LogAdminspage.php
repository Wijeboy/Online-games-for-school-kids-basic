...
<link rel="stylesheet" href="styles [CSS]/stylesloginadmin.css">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css">
	
	
</head>
<title>Login Admins page</title>
...
<li id="logo"><a href="#"> <img src="resources(src)/images/profile.png" width="35px" height="35px"></a></li>
  ...
  <div class="container1">
        <div class="header">
            ...
            <button class="lbtn"><a href="#">Main Admin</a></button>
			
			<button class="lbtn"><a href="RegisterAdmin.php">Register Admin</a></button>
			
			<button class="lbtn"><a href="faqphp.php">FAQ Admin</a></button>
			
			<button class="lbtn"><a href="#">Cart Admin</a></button>
			
			<button class="lbtn"><a href="#">Event Admin</a></button>
			
			<button class="lbtn"><a href="#">Support Admin</a></button>
